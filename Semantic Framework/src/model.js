...
if (typeof module !== "undefined") {
  module.exports = TransformerModel;           // CJS → const TransformerModel = require(…)
  module.exports.default = TransformerModel;   // ESM default re-export
}
export default TransformerModel;               // ESM → import TransformerModel from …